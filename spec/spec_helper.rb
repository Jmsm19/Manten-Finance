...
SimpleCov.start 'rails' do
  add_filter [/_mailer/, /_job/, 'channel', 'connection', 'static_controller']
end
...
def format_user_as_serializer(user)
  {
    'data' => {
...
RSpec.configure do |config|
  ...
  #   # you can fix the order by providing the seed,
  #   # which is printed after each run.
  #   #     --seed 1234
  #   config.order = :random
  #
